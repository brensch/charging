...
type PlugStatus struct {
	...
	Id            string                  `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty" firestore:"id"`
	State         *StateMachineTransition `protobuf:"bytes,2,opt,name=state,proto3" json:"state,omitempty" firestore:"state"`
	LatestReading *Reading                `protobuf:"bytes,3,opt,name=latest_reading,json=latestReading,proto3" json:"latest_reading,omitempty" firestore:"latest_reading"`
}
...
var file_contracts_objects_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x37, 0x0a, 0x05, 0x73, 0x74,
	0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x63, 0x6f, 0x6e, 0x74,
	...
	0x61, 0x64, 0x69, 0x6e, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x63, 0x6f,
