...
type AutoTopupPreferences struct {
	...
	ThresholdCents        float64 `protobuf:"fixed64,3,opt,name=threshold_cents,json=thresholdCents,proto3" json:"threshold_cents,omitempty" firestore:"threshold_cents"`
	RechargeValueCentsAud float64 `protobuf:"fixed64,4,opt,name=recharge_value_cents_aud,json=rechargeValueCentsAud,proto3" json:"recharge_value_cents_aud,omitempty" firestore:"recharge_value_cents_aud"`
}
...
func (x *AutoTopupPreferences) GetThresholdCents() float64 {
	if x != nil {
...
func (x *AutoTopupPreferences) GetRechargeValueCentsAud() float64 {
	if x != nil {
...
var file_contracts_stripe_proto_rawDesc = []byte{
	...
	0x01, 0x52, 0x0e, 0x74, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x43, 0x65, 0x6e, 0x74,
	...
	0x01, 0x28, 0x01, 0x52, 0x15, 0x72, 0x65, 0x63, 0x68, 0x61, 0x72, 0x67, 0x65, 0x56, 0x61, 0x6c,
